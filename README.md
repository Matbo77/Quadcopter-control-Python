...
$$
 \begin{array}{lll}
    ...
    \ddot{y} \\ 
    \ddot{z} \end{bmatrix} &=& \begin{bmatrix} 0 \\ 0 \\ -g \end{bmatrix} + \frac{1}{m}R^{-1}(\phi,\theta,\psi) \begin{bmatrix} 0 \\ 0 \\ u_1 \end{bmatrix}  - \frac{1}{m}k_D \begin{bmatrix} \dot{x} \\ \dot{y} \\ \dot{z} \end{bmatrix} \\
